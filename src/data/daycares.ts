...
export const DAYCARES: Daycare[] = [
  {
    ...
    name: '병아리어린이집',
    district: 'nam',
    address: '대구광역시 남구 현충로25길 42-9 (대명동)',
    phone: '053-653-2293',
    capacity: 35,
    current: 35,
    teachers: 12,
    hasBus: true,
    extended: true,
    features: ['영아전담', '장애아통합', '야간연장', '휴일보육'],
    programs: ['발도르프 교육', '숲 체험 학습', '오감 놀이', '동화 구연'],
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1544776193-352d25ca82cd?w=600&h=400&fit=crop&q=80',
    lat: 35.8294,
    lng: 128.5554,
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1606092195730-5d7b9af1efc5?w=600&h=400&fit=crop&q=80',
    lat: 35.8875,
    lng: 128.6104,
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1588075592446-265fd1e6e76f?w=600&h=400&fit=crop&q=80',
    lat: 35.8798,
    lng: 128.6286,
  },
  {
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1567752881298-894bb81f9379?w=600&h=400&fit=crop&q=80',
    lat: 35.8720,
    lng: 128.5710,
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1541692641319-981cc79ee10a?w=600&h=400&fit=crop&q=80',
    lat: 35.8070,
    lng: 128.5280,
  },
];
